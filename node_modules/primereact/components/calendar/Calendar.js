    ...
    _createClass(Calendar, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (nextProps.value !== this.props.value || nextProps.minDate !== this.props.minDate || nextProps.maxDate !== this.props.maxDate) {
                var date = this.getMonthYearDate(nextProps.value);
                var month = date.getMonth();
                var year = date.getFullYear();
        ...
        value: function renderDatePickerHeader() {
            if (!this.props.timeOnly) {
                var prevLink = this.renderDatePickerNavigatorLink('ui-datepicker-prev ui-corner-all', this.prevMonth, 'fa fa-angle-left');
                var nextLink = this.renderDatePickerNavigatorLink('ui-datepicker-next ui-corner-all', this.nextMonth, 'fa fa-angle-right');
