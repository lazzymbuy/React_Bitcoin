...
.ui-inputtext:focus {
  outline: 0 none;
  border-color: #b2a266;
  -moz-box-shadow: 0px 0px 5px #b2a266;
  -webkit-box-shadow: 0px 0px 5px #b2a266;
  box-shadow: 0px 0px 5px #b2a266; }
...
.ui-datatable .ui-datatable-data > tr.ui-datatable-dragpoint-top > td {
  box-shadow: inset 0 2px 0 0 #654b24; }
...
.ui-treetable .ui-treetable-row.ui-treetable-row-selectable:not(.ui-state-highlight):hover {
  background: #f7f3de;
  color: #3a3427; }
.ui-treetable .ui-sortable-column:not(.ui-state-active):hover {
  background: #f7f3de;
  color: #3a3427; }
...
.ui-datepicker .ui-datepicker-header a {
  ...
  .ui-datepicker .ui-datepicker-header a:hover {
    ...
    .ui-datepicker .ui-datepicker-header a:hover a {
      color: #3a3427; }
.ui-datepicker .ui-datepicker-calendar tbody > tr .ui-datepicker-selectable-other-month a:hover {
  border-color: #b2a266;
  background: #f7f3de;
  color: #3a3427; }
  .ui-datepicker .ui-datepicker-calendar tbody > tr .ui-datepicker-selectable-other-month a:hover a {
    color: #3a3427; }
...
.ui-organizationchart .ui-organizationchart-line-left {
  border-right: 1px solid #c5c0a5; }
.ui-organizationchart .ui-organizationchart-line-top {
  border-top: 1px solid #c5c0a5; }
